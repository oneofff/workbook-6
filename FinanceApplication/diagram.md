...
direction TB
    ...
    class com.pluralsight.model.BankAccount {
        - double balance
        - double debt
        - String name
		
        + com.pluralsight.model.BankAccount(double balance, double debt, String name)
    ...
    Valuable --|>  com.pluralsight.model.BankAccount 
    Valuable --|> CreditCard  
    FixedAsset --|> Jewelry
    FixedAsset --|> Gold
    FixedAsset --|> House
